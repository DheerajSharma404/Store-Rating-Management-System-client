    ...
    <div className='flex h-full'>
      ...
      <div className='flex flex-col flex-1 '>
        <div className=' p-4 flex  w-full h-fit items-center font-bold gap-4'>
          <div className='w-full h-32 bg-slate-400 flex  items-center  px-6'>
            <span className=' text-6xl'>
              4.2
              <span className='text-4xl text-center'> / 5 Average Rating</span>
            </span>
          </div>
        </div>
        <div className='p-4 flex  items-center justify-between   w-full h-fit gap-6'>
          <p className='text-4xl font-bold text-center pb-2'>Rating&apos;s</p>
